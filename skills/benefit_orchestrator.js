...
module.exports = {
  ...
  description: 'AI 权益管家。当用户问某商品有什么优惠/怎么领国补/学生(教师/企业)能便宜多少/帮我算到手价/以旧换新能抵多少，或在「一键领取优惠/购买」场景，调用本工具：按用户身份与场景编排可叠加的官方权益（国补/教育券/会员券/乐豆/以旧换新/分期/延保），算出到手价瀑布，每项标注优惠来源解释，并给出公平预算池审计。不做隐形高低价——标价稳定，差异只在可解释的券与权益。',
  parameters: {
    type: 'object',
    properties: {
