...
const pocLogRecords = [
  {
    time: '2026-08-14 15:10',
    operator: 'Codex（协作代理）',
    title: 'Skill 能力变更同步人工闭环',
    scope: 'Skill Hub / 能力变化详情 / Skill 创建 / 评估审核',
    detail: '基于能力变更同步 PRD，使用独立 service 变化记录；Skill Hub 默认展示产品知识问答、券包权益推荐两条能力更新，可直接进入变化详情和后续更新流程，不再提供用户侧模拟入口。汇总区同时保留“能力更新”和“已禁用”卡片，两张卡片可分别筛选对应 Skill；已发布 Skill 的“禁用”和已禁用 Skill 的“启用”操作保持不变。Skill Hub 继续展示生命周期与更新双状态、检测时间、变化摘要、前后值及影响详情。负责人或管理员可从线上版本创建或继续更新草稿，旧线上版本在新版本发布前持续可用，新增能力不自动勾选；编辑页持续提示目标能力版本。提审门槛统一为综合评分 0.80，0.782 阻断，AI 微调到 0.859 后开放提交；新版本发布后更新状态闭环。未接入真实扫描、邮件和权限服务，公共导航、右侧 Agent 与其他业务页面保持不变。',
    status: '已更新 new 预览'
  },
  {
