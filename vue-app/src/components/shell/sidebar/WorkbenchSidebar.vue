...
const pocLogRecords = [
  {
    ...
    detail: '基于能力变更同步 PRD，新增独立 mock/service 变化记录；new 预览的 Skill Hub 提供“模拟能力变化”入口，可分别激活接口和字段新增、权限点变化场景并重置演示数据，正式环境不显示该入口。Skill Hub 支持“只看有更新”、能力更新指标、生命周期与更新双状态、检测时间、变化摘要、前后值及影响详情。负责人或管理员可从线上版本创建或继续更新草稿，旧线上版本在新版本发布前持续可用，新增能力不自动勾选；编辑页持续提示目标能力版本。提审门槛统一为综合评分 0.80，0.782 阻断，AI 微调到 0.859 后开放提交；新版本发布后更新状态闭环。未接入真实扫描、邮件和权限服务，公共导航、右侧 Agent 与其他业务页面保持不变。',
    status: '已更新 new 预览'
  },
  {
