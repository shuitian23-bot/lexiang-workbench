...
.custom-table-auth { container: custom-auth / inline-size; }
.editor-head, .rule-card-head, .rule-card-head > div:last-child { flex-wrap: wrap; }
.summary-grid p { white-space: normal; overflow-wrap: anywhere; }
@container custom-auth (max-width: 719px) { .summary-grid { grid-template-columns: minmax(0, 1fr); } .matrix-preview summary { flex-wrap: wrap; } }
</style>
<style scoped>
