export const pocLogServerRecords = [
  {
    "time": "2026-08-20 10:40",
    "operator": "zhangrui（协作工作区）",
    "codeAuthor": "Codex（协作代理）",
    "sourceRef": "integration/zhangrui-20260820；设计基线 portal-workbench-ui-0818；产品方案 portal-workbench-capability-context-controlled-update-product-plan-20260819.md；功能提交 3721fff、e093af0、65da5d0、c6737c3、6efd460、f12e006、0f2bd35、4cb4053；正式协作历史合并 6996071",
    "traceStatus": "已从服务器正式 main 最新提交建立隔离集成分支，核对并保留正式站后续 SMB 调整、其他成员提交及受保护 admin-runtime；仅带入完整 Vue 源码、0818 设计规范和本次工作台构建产物。55 项产品契约、Lint、类型检查、生产构建、壳层冒烟、汇总卡与编辑链路浏览器验收及保护文件哈希检查通过；按增量资源方式依次更新 new 和正式环境，并同步 GitLab dev/zhangrui、服务器 incoming/zhangrui 与 main。",
  ...
  },
  {
    ...
    "traceStatus": "已在个人隔离 worktree 完成 P0 源码、契约测试、构建和冲突检查，增量更新 new 预览并修复旧浏览器状态隐藏变化标记的问题；确认预览后增量合并正式链接，同步 GitLab dev/zhangrui 和服务器 incoming/zhangrui，并在保留正式当前文件树的前提下记录 main 合并关系。",
  ...
  {
    "time": "2026-08-18 17:02",
    "operator": "zhangrui（协作工作区）",
    "codeAuthor": "Codex（协作代理）",
    "sourceRef": "dev/zhangrui-menu-additions；功能提交 3472234、59bb109、d4a7d12；需求来源 _0708_analysis (2).zip、_0708_analysis (3).zip",
    "traceStatus": "已在个人隔离 worktree 完成源码、构建产物和浏览器交互验证；通过 incoming/zhangrui 合入服务器 Git，并依次更新 new 预览和正式链接。",
    ...
    "detail": "企业客户管理新增“线索池-政企”，按最新设计包提供政企线索只读查询、组合筛选、排序、分页、详情和脱敏/审批明文导出；订单管理保留“协议采购单管理”，新增“协议产品订单管理”，按最新设计包提供协议名称、采购单号、订单号和状态查询，当前筛选结果导出、分页和独立订单详情。两项新增均使用隔离页面和运行模块，不修改其他菜单、右侧 AI 助手、权限管理或既有订单流程。",
    "deployTargets": [
      "new",
      "formal"
    ],
