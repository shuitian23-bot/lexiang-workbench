export const pocLogServerRecords = [
  {
    ...
    "sourceRef": "dev/zhangrui-ui-0818-capability；设计基线 portal-workbench-ui-0818；产品方案 portal-workbench-capability-context-controlled-update-product-plan-20260819.md；本地提交 3721fff、e093af0、65da5d0、c6737c3",
    "traceStatus": "已基于 origin/dev/zhangrui 最新提交在独立 worktree 完成 0818 设计治理接入、P0 规则补齐、54 项产品契约测试、Lint、类型检查、生产构建、壳层冒烟和保护文件哈希检查；已通过增量资源方式更新 new 预览，正式环境与 GitLab 尚未更新。",
