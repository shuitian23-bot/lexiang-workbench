            ...
            <div class="skill-code-card skill-draft-workspace">
              <aside class="skill-draft-tree" aria-label="Skill 草稿文件树">
                <div class="skill-draft-tree-head">
                  <span>Docs</span>
                  <small>skill-draft</small>
                </div>
                <div class="skill-draft-tree-body">
                  <div class="skill-tree-row folder open">
                    <span class="skill-tree-caret">▾</span>
                    <span class="skill-tree-badge">DIR</span>
                    <b>employee_certification_analysis</b>
                    <em>4</em>
                  </div>
                  <button type="button" class="skill-tree-row file active">
                    <span class="skill-tree-caret"></span>
                    <span class="skill-tree-badge">YAML</span>
                    <b>skill.yaml</b>
                  </button>
                  <button type="button" class="skill-tree-row file">
                    <span class="skill-tree-caret"></span>
                    <span class="skill-tree-badge">MD</span>
                    <b>business_rules.md</b>
                  </button>
                  <button type="button" class="skill-tree-row file">
                    <span class="skill-tree-caret"></span>
                    <span class="skill-tree-badge">JSON</span>
                    <b>test_cases.json</b>
                  </button>
                  <button type="button" class="skill-tree-row file">
                    <span class="skill-tree-caret"></span>
