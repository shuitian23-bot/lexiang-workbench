      (() => {
        ...
        const LX_SUGGEST_TREE = {
          ...
          // 槽位2：用途（按品类分支，说了买什么但没说干什么用）
          usage: {
            test: (t) => /电脑|笔记本|游戏本|轻薄本|台式/.test(t) && !/手机|平板|显示器/.test(t) && !/游戏|办公|学习|设计|创作|剪辑|编程|送人|网课|建模|学生/.test(t),
            title: "主要用来做什么？",
            options: [
              ["用来玩游戏", "", "用来玩游戏，"],
              ["用来办公/学习", "", "用来办公和学习，"],
          ...
          // 槽位3：预算
          budget: {
            test: (t) => /电脑|笔记本|游戏本|轻薄本|手机|平板|显示器|台式/.test(t) && /游戏|办公|学习|设计|创作|剪辑|编程|送人|网课|拍照|拍视频|商务|长辈|备用|追剧|绘画|孩子|电竞|高刷|修图|护眼/.test(t) && !/\d+\s*(元|块|千|万|k|K|W)|预算|价格不限|不限/.test(t),
            title: "预算大概多少？",
            options: [
              ["5000 元以下", "", "预算5000元以下，"],
        ...
        function lxDetectSuggest(text) {
          ...
          for (const key of ["category", "usage", "usage_phone", "usage_pad", "usage_monitor", "budget", "portable"]) {
