(function () {
  ...
  function memberAssetPage(type) {
    ...
    return '<section class="leai-page leai-member-asset-page" data-member-asset-page="' + type + '" aria-labelledby="leaiAssetTitle-' + type + '"><header class="leai-page-header"><div><p class="leai-page-kicker">会员资产</p><h1 class="leai-page-title" id="leaiAssetTitle-' + type + '">' + page.label + '</h1><p class="leai-page-desc">' + page.description + '</p></div><span class="leai-status-pill"><img src="' + icons.check + '" alt="">账户已同步</span></header>' +
