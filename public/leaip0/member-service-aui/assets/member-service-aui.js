(function () {
  ...
  function memberAssetPage(type) {
    ...
    var hideAssetHeader = ["points", "coupons", "vouchers", "redpacket"].indexOf(type) !== -1;
    var assetHeader = hideAssetHeader ? "" : '<header class="leai-page-header"><div><div class="leai-page-title-row"><button class="leai-page-back" type="button" data-secondary-back="member" aria-label="返回会员中心"><img src="' + icons.next + '" alt=""></button><h1 class="leai-page-title" id="leaiAssetTitle-' + type + '">' + page.label + '</h1></div><p class="leai-page-desc">' + page.description + '</p></div></header>';
    return '<section class="leai-page leai-member-asset-page" data-member-asset-page="' + type + '"' + (hideAssetHeader ? '' : ' aria-labelledby="leaiAssetTitle-' + type + '"') + '>' + assetHeader +
