...
(function () {
  ...
  function init() {
    if (!document.getElementById('lx-solution-list-header-hidden')) {
      ...
      solutionStyle.textContent = '.info-page:has(> .lx-solution-center-page) > .reco-head, .lx-solution-center-page > .lx-solution-tabs { display: none !important; } .lx-solution-center-page .lx-solution-card > em { display: none !important; } html body .content .lx-sd-entity-card[data-solution-product-detail] .lx-sd-entity-card-copy > em { display:none!important; } html body .content .lx-solution-center-page .lx-solution-card { border:0!important; } html body main.shell > section.content[data-view="info"]:has(.lx-solution-center-page) { background-color:#f5f5f7!important; background-image:linear-gradient(180deg,#fff 0,#fff 74px,#fefefe 96px,#fafafa 122px,#f7f7f8 164px,#f5f5f7 214px,#f5f5f7 100%)!important; background-repeat:no-repeat!important; } html body main.shell > section.content[data-view="info"] .info-page:has(.lx-solution-center-page), html body .content .lx-solution-center-page, html body .content .lx-solution-center-page .lx-solution-floor { background:transparent!important; }';
