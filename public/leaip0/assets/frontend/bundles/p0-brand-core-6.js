...
(function () {
  ...
  function init() {
    if (!document.getElementById('lx-solution-list-header-hidden')) {
      ...
      solutionStyle.textContent = '.info-page:has(> .lx-solution-center-page) > .reco-head, .lx-solution-center-page > .lx-solution-tabs { display: none !important; } .lx-solution-center-page .lx-solution-card > em { display: none !important; }';
