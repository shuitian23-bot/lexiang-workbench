...
(() => {
  ...
  readonlyStyle.textContent = '[data-buy-modal-direct] [data-checkout-disabled="true"]{color:#aaa4ad!important;background:#f1eef3!important;border-color:#e4dfe7!important;cursor:not-allowed!important;box-shadow:none!important;opacity:.68!important}[data-buy-modal-direct] .lx-buy-price-line[data-checkout-disabled="true"]{background:transparent!important}[data-buy-modal-direct] [data-checkout-disabled="true"] .arrow{visibility:hidden}.lx-checkout-detail-surface{min-height:100%;background:white}.lx-checkout-detail-surface [data-order-detail]{display:block!important}.lx-checkout-order-preview{margin-top:12px}';
