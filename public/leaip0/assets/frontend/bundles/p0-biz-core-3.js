...
;/* public/leaip0/assets/frontend/js/core/enterprise-banner-v122.js */
(function(){"use strict";window.__lxEnterpriseBanner=[{"sector": "制造", "industry": "智能制造", "solution": "联想智能工厂解决方案", "paper": "绿色制造实践白皮书", "image": "联想智能工厂解决方案.jpg", "intro": "绿色制造围绕生产效率与资源利用展开，重点关注设备连接、产线协同、能耗监测和质量追溯。企业可先梳理高耗能环节与关键工序，再结合边缘计算和数据平台形成可持续优化的生产闭环。", "text": "**绿色制造实践白皮书主题解读：**绿色制造围绕生产效率与资源利用展开，重点关注设备连接、产线协同、能耗监测和质量追溯。企业可先梳理高耗能环节与关键工序，再结合边缘计算和数据平台形成可持续优化的生产闭环。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《绿色制造实践白皮书》"}, {"sector": "教育", "industry": "智慧教育", "solution": "智慧教室解决方案", "paper": "智慧教育解决方案白皮书", "image": "智慧教室解决方案.jpg", "intro": "智慧教育围绕课堂教学、校园管理与教学科研展开，重点关注终端统一管理、教学资源共享和师生协作。学校可先梳理教室网络、现有设备与课程需求，再结合云桌面、互动显示和数据平台逐步完善教学环境。", "text": "**智慧教育解决方案白皮书主题解读：**智慧教育围绕课堂教学、校园管理与教学科研展开，重点关注终端统一管理、教学资源共享和师生协作。学校可先梳理教室网络、现有设备与课程需求，再结合云桌面、互动显示和数据平台逐步完善教学环境。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《智慧教育解决方案白皮书》"}, {"sector": "政府", "industry": "数字政府", "solution": "数字政府统一运维方案", "paper": "数字政府建设白皮书", "image": "数字政府统一运维方案.jpg", "intro": "数字政府围绕跨部门协同、公共服务与统一运维展开，重点关注系统整合、数据共享和权限管理。建设前应梳理现有应用、数据责任与服务流程，再结合统一平台和运维体系提升业务协作效率与服务连续性。", "text": "**数字政府建设白皮书主题解读：**数字政府围绕跨部门协同、公共服务与统一运维展开，重点关注系统整合、数据共享和权限管理。建设前应梳理现有应用、数据责任与服务流程，再结合统一平台和运维体系提升业务协作效率与服务连续性。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《数字政府建设白皮书》"}, {"sector": "医疗", "industry": "智慧医疗", "solution": "多院区/区域医疗中心基础设施解决方案", "paper": "智慧医疗建设白皮书", "image": "多院区/区域医疗中心基础设施解决方案.jpg", "intro": "智慧医疗围绕多院区协同、医疗数据管理与服务连续性展开，重点关注基础设施整合、终端管理和数据备份。医院可先梳理业务系统的运行需求及院区网络，再分阶段完善资源调度、访问控制与故障恢复能力。", "text": "**智慧医疗建设白皮书主题解读：**智慧医疗围绕多院区协同、医疗数据管理与服务连续性展开，重点关注基础设施整合、终端管理和数据备份。医院可先梳理业务系统的运行需求及院区网络，再分阶段完善资源调度、访问控制与故障恢复能力。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《智慧医疗建设白皮书》"}, {"sector": "金融", "industry": "智慧金融", "solution": "金融行业DCM数据中心管理平台", "paper": "金融行业数字化白皮书", "image": "金融行业DCM数据中心管理平台.jpg", "intro": "金融数字化围绕数据中心管理、网点协同与业务连续性展开，重点关注资源可视化、运行监控和访问权限。机构可先梳理关键系统及服务等级，再结合统一运维、容量规划和灾备演练，逐步改善基础设施运营能力。", "text": "**金融行业数字化白皮书主题解读：**金融数字化围绕数据中心管理、网点协同与业务连续性展开，重点关注资源可视化、运行监控和访问权限。机构可先梳理关键系统及服务等级，再结合统一运维、容量规划和灾备演练，逐步改善基础设施运营能力。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《金融行业数字化白皮书》"}, {"sector": "能源", "industry": "智慧能源", "solution": "智慧电厂解决方案", "paper": "智慧能源建设白皮书", "image": "智慧电厂解决方案.jpg", "intro": "智慧能源围绕生产监测、设备巡检与运行管理展开，重点关注现场数据采集、异常识别和多系统协同。企业可先梳理关键设备与网络边界，再结合边缘计算、数字化平台和运维流程，逐步提升运行可视性与响应效率。", "text": "**智慧能源建设白皮书主题解读：**智慧能源围绕生产监测、设备巡检与运行管理展开，重点关注现场数据采集、异常识别和多系统协同。企业可先梳理关键设备与网络边界，再结合边缘计算、数字化平台和运维流程，逐步提升运行可视性与响应效率。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《智慧能源建设白皮书》"}, {"sector": "交通", "industry": "智慧交通", "solution": "轨交智能运营解决方案", "paper": "智慧交通建设白皮书", "image": "轨交智能运营解决方案.jpg", "intro": "智慧交通围绕场站运营、设备管理与调度协同展开，重点关注实时数据汇聚、基础设施稳定性和异常处置。运营方可先梳理现场网络与关键业务链路，再结合云平台、边缘计算和统一运维，逐步完善跨站点协同能力。", "text": "**智慧交通建设白皮书主题解读：**智慧交通围绕场站运营、设备管理与调度协同展开，重点关注实时数据汇聚、基础设施稳定性和异常处置。运营方可先梳理现场网络与关键业务链路，再结合云平台、边缘计算和统一运维，逐步完善跨站点协同能力。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《智慧交通建设白皮书》"}, {"sector": "服务", "industry": "智能基础设施", "solution": "智慧零售连锁门店解决方案", "paper": "现代服务业数字化白皮书", "image": "智慧零售连锁门店解决方案.jpg", "intro": "服务行业数字化围绕门店协作、业务系统与客户服务展开，重点关注终端统一管理、数据连接和运营可视化。企业可先梳理多网点流程及系统接口，再结合云平台和统一运维，逐步改善协同效率与业务扩展能力。", "text": "**现代服务业数字化白皮书主题解读：**服务行业数字化围绕门店协作、业务系统与客户服务展开，重点关注终端统一管理、数据连接和运营可视化。企业可先梳理多网点流程及系统接口，再结合云平台和统一运维，逐步改善协同效率与业务扩展能力。\n\n**落地建议：**优先选择目标明确、可衡量的试点，确认兼容性、安全边界、交付范围和运维责任，再依据试点结果逐步扩展。\n\n**阅读提示：**点击下方小卡手动查看资料弹窗；当前为演示资料，正式内容及适用条件以官方交付版本为准。", "query": "解读《现代服务业数字化白皮书》"}];})();
