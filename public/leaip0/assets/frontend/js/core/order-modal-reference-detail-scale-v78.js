(function () {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .co.lx-order-skin .price-detail-panel { display:none!important;margin-top:12px!important;padding:15px 18px!important;border-radius:14px!important;background:#f3f0f7!important; }
      .co.lx-order-skin .price-detail-panel.is-open { display:block!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-detail-list { gap:13px!important;margin-top:0!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-row { gap:13px!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-ck { width:23px!important;height:23px!important;margin-top:1px!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-ck .lx-approved-icon,
      .co.lx-order-skin .price-detail-panel .lx-discount-ck .lx-approved-icon-img { width:14px!important;height:14px!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-name { font-size:17px!important;line-height:1.4!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-desc { margin-top:3px!important;font-size:14px!important;line-height:1.4!important; }
      .co.lx-order-skin .price-detail-panel .lx-discount-amt { font-size:17px!important;line-height:1.4!important; }
