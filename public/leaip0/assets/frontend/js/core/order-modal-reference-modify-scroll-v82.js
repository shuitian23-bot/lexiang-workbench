  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask {
        align-items:flex-start!important;padding:28px 20px!important;overflow:auto!important;
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal.lx-modify-order-skin {
        width:min(992px,calc(100vw - 40px))!important;max-height:calc(100vh - 56px)!important;zoom:.625!important;
        padding:0!important;border:0!important;border-radius:30px!important;background:#fff!important;
        box-shadow:0 28px 80px rgba(32,19,42,.28)!important;overflow-x:hidden!important;overflow-y:auto!important;overscroll-behavior:contain!important;
        animation:lxRefModalIn .42s cubic-bezier(.2,.86,.22,1) both!important;
      }
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal-title {
        position:relative!important;display:inline-block!important;margin:0!important;padding-left:40px!important;
        font-size:30px!important;line-height:1.2!important;font-weight:600!important;letter-spacing:-.5px!important;
        background:linear-gradient(90deg,#4d144a 11.9%,#b8252e 100%)!important;
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal-title:after {
        content:""!important;position:absolute!important;clip-path:polygon(50% 0,62% 36%,100% 50%,62% 64%,50% 100%,38% 64%,0 50%,38% 36%)!important;
      }
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal-title:before { left:4px!important;top:8px!important;width:18px!important;height:18px!important;background:linear-gradient(135deg,#76105f,#e92835)!important; }
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal-title:after { left:24px!important;top:0!important;width:10px!important;height:10px!important;background:#e7a4a0!important; }
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal-body { padding:0 40px 34px!important;overflow:visible!important; }
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-mo-skin { display:flex!important;flex-direction:column!important;gap:16px!important; }
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask textarea.lx-mo-field {
        box-sizing:border-box!important;width:100%!important;height:56px!important;padding:0 18px!important;border:1px solid #e6e0ed!important;border-radius:14px!important;
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask textarea.lx-mo-field { height:96px!important;padding:14px 18px!important;resize:none!important; }
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-mo-actions { display:grid!important;grid-template-columns:1fr 1.58fr!important;gap:18px!important;margin-top:2px!important; }
