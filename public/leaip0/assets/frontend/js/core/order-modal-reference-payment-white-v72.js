(function () {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .co.lx-order-skin .pay-row .chev { display:inline-flex!important;align-items:center!important;justify-content:center!important;width:12px!important;height:12px!important;color:#36303a!important;transform:rotate(-90deg)!important;transform-origin:center!important;transition:transform .24s cubic-bezier(.2,.8,.2,1)!important; }
      .co.lx-order-skin .pay-row .chev .lx-payment-chevron-icon { display:block!important;width:12px!important;height:7px!important; }
      .co.lx-order-skin .lx-ref-payment-card:has(.pay-picker.is-open) .pay-row .chev { transform:rotate(90deg)!important; }
      ...
      .co.lx-order-skin .pay-opt { display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;height:44px!important;padding:0 14px!important;border:1px solid #e6e0ed!important;border-radius:10px!important;background:#fff!important;font-size:18px!important;line-height:1!important;text-align:center!important; }
