(function () {
  ...
  var recommendationScene = {
    labels: function(content) {
      return content.querySelector('.reco-page.lx-service-reco-page') ? serviceActions : actions;
    },
  ...
  function syncPageScene() {
    ...
    var key = (serviceVisible ? 'service' : content.getAttribute('data-view')) + ':' + scene.identity(content);
