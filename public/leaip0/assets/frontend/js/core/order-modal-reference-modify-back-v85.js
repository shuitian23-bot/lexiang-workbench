(function () {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-modify-order-back img { display:block!important;width:22px!important;height:22px!important;transform:rotate(180deg)!important; }
  ...
  function syncModifyOrderModal() {
    document.querySelectorAll(".lx-p0-modal-mask").forEach(function (mask) {
      ...
      if (modifyForm && head && !head.querySelector(".lx-modify-order-back")) {
        ...
        back.innerHTML = '<img src="../icons/global-next.svg" alt="" aria-hidden="true">';
