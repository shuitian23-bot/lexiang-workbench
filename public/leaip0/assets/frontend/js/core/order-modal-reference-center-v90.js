  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .lx-p0-modal-mask.lx-modify-order-modal-mask .lx-p0-modal.lx-modify-order-skin {
        display:flex!important;flex-direction:column!important;width:min(1240px,calc(100vw - 56px))!important;
        height:calc(156.25vh - 87.5px)!important;max-height:calc(156.25vh - 87.5px)!important;zoom:.64!important;
