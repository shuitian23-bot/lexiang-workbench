/* Original scene-banner.html is rendered byte-for-byte in its own document.
...
(function () {
  ...
  frame.src = '/assets/components/scene-banner-v153/scene-banner-original.html';
  ...
  host.style.cssText = 'position:relative;width:100%;min-width:0;height:0;overflow:hidden;margin:0;';
  const style = document.createElement('style');
  style.textContent = `
    #p0OriginalSceneBanner { display:none; }
    body[data-page="personal"]:not(.assistant-fullscreen) .content[data-view="list"] > #p0OriginalSceneBanner[data-ready] { display:block; }
    .content:has(> #p0OriginalSceneBanner[data-ready]) > .device-scene-hall { display:none!important; }
