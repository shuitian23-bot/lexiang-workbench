/* 方案详情 — P0 business implementations. */
if (!window.__p0Modules.installed["pages/solution-detail"]) {
window.__p0Modules.installed["pages/solution-detail"]=true;

/* scripts/p0-source-runtime/leaip0/assets/frontend/js/core/industry-solutions-v114.js */
window.__p0Modules.sources["u494b4df1164a187a"]=function(){
(function(root){
"use strict";
...
/* scripts/p0-source-runtime/leaip0/assets/frontend/js/core/whitepaper-action-cards-v124.js */
window.__p0Modules.sources["u69895e7f6ebbbcf6"]=function(){
...
(function(){
  ...
  style.textContent=window.__p0Modules.styleText("/@script-style/585f25a91fce02fa42c317c6.css");
...
window.__p0Modules.factories["pages/solution-detail#updateDetails:07e0989f1badb4452673119f"]=function(__p0Scope){"use strict";return (function updateDetails() {
    document.querySelectorAll('.content .lx-specific-solution-detail').forEach(page => {
      if (page.dataset.lxManufacturingContent === __p0Scope.revision) return;
      const name = page.querySelector('.lx-sd-hero h1')?.textContent;
      const sector = page.querySelector('.lx-sd-tags small')?.textContent.trim();
      const item = (0,__p0Scope.get)(name,sector);
      if (!item) return;
      ...
      if (heroImage) heroImage.src = (0,__p0Scope.asset)(item.image);
      ...
      (0,__p0Scope.addNotice)(page);
      page.dataset.lxManufacturingContent = __p0Scope.revision;
    });
  }); };
}
