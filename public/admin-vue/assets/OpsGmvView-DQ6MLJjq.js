import{E as P,f as F,m as b,h as q,_ as W,q as z,i as j,c as U,o as Y}from"./index-u8WNTVx1.js";import{u as J}from"./ai-0TKD0ZYi.js";import{r as u,O as i,a as K,b as N,s as m,g as r,d as l,e as Q}from"./opsData-kyn-tTzR.js";const X=["innerHTML"],at=P({__name:"OpsGmvView",setup(Z){const G=F(),w=J();let d=null;const g=b("30d"),p=b(u(i[0].d)),v=b(u(i[i.length-1].d)),h=b("all"),k=b(M()),f=[],y=[{name:"消费",key:"consumer",color:l.blue,weight:.66},{name:"SMB",key:"smb",color:l.amber,weight:.3},{name:"政企",key:"gov",color:l.purple,weight:.04}];q(async()=>{G.ensureStaticTab("ops.gmv"),G.setActiveStaticTab("ops.gmv"),document.title="GMV 分析 - 乐享 AI 工作台",A(),d=await W(()=>import("./index-BzBQJFYZ.js"),[]),await z(),S()}),j(()=>{V(),delete window.opsAskGmv,delete window.opsCustomTimeChanged,delete window.opsSetGmvTrendScope,delete window.opsTimeChanged});function M(){return`
  ...
  </div>`}function A(){window.opsTimeChanged=async(t,o)=>{g.value=o,await $()},window.opsCustomTimeChanged=async(t,o,e)=>{g.value="custom",o==="start"&&(p.value=e),o==="end"&&(v.value=e),p.value>v.value&&(o==="start"?v.value=p.value:p.value=v.value),await $()},window.opsSetGmvTrendScope=async t=>{h.value=t,S()},window.opsAskGmv=()=>{w.toggleOpen(!0),w.quickSend("基于当前GMV分析看板，分析GMV趋势、分业务贡献、平台结构、风险和优先动作。","ops.gmv")}}async function $(){k.value=M(),await z(),S()}function S(){V();const t=N(i,g.value,p.value,v.value),o=t.map(s=>s.d),e={gmv:m(t,"gmv"),buy:m(t,"buy"),offGmv:m(t,"offGmv"),nonGmv:m(t,"nonGmv"),offBuy:m(t,"offBuy"),nonBuy:m(t,"nonBuy")},a=O(e.gmv,e.buy);n("ops-g-total",r(e.gmv)),n("ops-g-buy",e.buy.toLocaleString()),n("ops-g-consumer",r(a[0].value)),n("ops-g-smb",r(a[1].value)),n("ops-g-gov",r(a[2].value)),n("ops-g-consumer-buy",a[0].buy.toLocaleString()),n("ops-g-smb-buy",a[1].buy.toLocaleString()),n("ops-g-gov-buy",a[2].buy.toLocaleString()),["all","consumer","smb","gov"].forEach(s=>{var c;(c=document.getElementById(`gmv-scope-${s}`))==null||c.classList.toggle("active",h.value===s)}),x("ops-g-trend-chart",o,E(t)),T("ops-g-biz-pie",a.map(s=>({name:s.name,value:s.value,color:s.color}))),I(a,e.gmv),T("ops-g-platform-chart",[{name:"官网",value:e.offGmv,color:l.blue},{name:"非官网",value:e.nonGmv,color:l.slate}]),x("ops-g-platform-trend",o,[{name:"官网",data:t.map(s=>s.offGmv),color:l.blue},{name:"非官网",data:t.map(s=>s.nonGmv),color:l.slate}])}function O(t,o){return y.map(e=>{const a=Math.round(t*e.weight),s=Math.round(o*e.weight),c=Math.round(a*.72);return{...e,value:a,buy:s,loginGmv:c,platformGmv:a-c}})}function E(t){if(h.value==="all")return[{name:"整体GMV",data:t.map(e=>e.gmv),color:l.blue,fill:!0}];const o=y.find(e=>e.key===h.value)||y[0];return[{name:`${o.name}GMV`,data:t.map(e=>Math.round(e.gmv*o.weight)),color:o.color,fill:!0}]}function I(t,o){const e=document.getElementById("ops-g-biz-table");e&&(e.innerHTML=t.map(a=>`<tr>
