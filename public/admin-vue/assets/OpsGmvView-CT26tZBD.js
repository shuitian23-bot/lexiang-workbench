import{G as j,g as q,p as u,i as W,_ as U,v as A,j as Y,c as J,o as K}from"./index-BfJGLjML.js";import{u as N}from"./ai-BK7-Nh59.js";import{r as m,O as i,a as Q,b as X,s as g,g as r,d as l,e as Z}from"./opsData-kyn-tTzR.js";const tt=["innerHTML"],it=j({__name:"OpsGmvView",setup(et){const k=q(),M=N();let d=null;const b=u("30d"),p=u(m(i[0].d)),v=u(m(i[i.length-1].d)),f=u("all"),$=u(x()),S=u(null),y=[];let h=null;const G=[{name:"消费",key:"consumer",color:l.blue,weight:.66},{name:"SMB",key:"smb",color:l.amber,weight:.3},{name:"政企",key:"gov",color:l.purple,weight:.04}];W(async()=>{k.ensureStaticTab("ops.gmv"),k.setActiveStaticTab("ops.gmv"),document.title="联想门户工作台",R(),d=await U(()=>import("./index-BzBQJFYZ.js"),[]),await A(),w(),S.value&&typeof ResizeObserver<"u"&&(h=new ResizeObserver(()=>requestAnimationFrame(()=>y.forEach(t=>t.resize()))),h.observe(S.value))}),Y(()=>{h==null||h.disconnect(),B(),delete window.opsAskGmv,delete window.opsCustomTimeChanged,delete window.opsSetGmvTrendScope,delete window.opsTimeChanged});function x(){return`
