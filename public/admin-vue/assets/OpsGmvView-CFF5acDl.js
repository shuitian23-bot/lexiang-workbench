import{G as P,f as F,p as b,h as W,_ as j,v as z,i as q,c as U,o as Y}from"./index-Cq-2AIDZ.js";import{u as J}from"./ai-B1Ahiv2z.js";import{r as u,O as i,a as K,b as N,s as m,g as r,d as l,e as Q}from"./opsData-kyn-tTzR.js";const X=["innerHTML"],at=P({__name:"OpsGmvView",setup(Z){const G=F(),w=J();let d=null;const g=b("30d"),p=b(u(i[0].d)),v=b(u(i[i.length-1].d)),h=b("all"),k=b(M()),f=[],y=[{name:"消费",key:"consumer",color:l.blue,weight:.66},{name:"SMB",key:"smb",color:l.amber,weight:.3},{name:"政企",key:"gov",color:l.purple,weight:.04}];W(async()=>{G.ensureStaticTab("ops.gmv"),G.setActiveStaticTab("ops.gmv"),document.title="GMV 分析 - 乐享 AI 工作台",A(),d=await j(()=>import("./index-BzBQJFYZ.js"),[]),await z(),S()}),q(()=>{V(),delete window.opsAskGmv,delete window.opsCustomTimeChanged,delete window.opsSetGmvTrendScope,delete window.opsTimeChanged});function M(){return`
