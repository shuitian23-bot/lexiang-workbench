(function () {
  ...
  var orders = [
    { purchase: 'B2026081701625', no: '260625101', agreement: 'KO260403250008', agreementName: '单显示器', customer: '陈思雨', goods: 'ThinkVision T24v-30 等2项', qty: 5, amount: 8000, address: '北京·海淀知春路', invoice: '电子/个人', status: '待发货' },
    { purchase: 'B2026081701626', no: '260625102', agreement: 'KO260403250008', agreementName: '单显示器', customer: '周建国', goods: 'ThinkVision TS27Q-40', qty: 3, amount: 2250, address: '天津·东丽空港', invoice: '电子/个人', status: '待签署合同' },
    { purchase: 'B2026081701627', no: '260624107', agreement: 'KO260403250012', agreementName: '办公整机协议', customer: '李博', goods: 'ThinkPad E14 等2项', qty: 8, amount: 46400, address: '上海·浦东金桥', invoice: '专票/企业', status: '已发货' },
    { purchase: 'B2026081701628', no: '260623103', agreement: 'KO260403250012', agreementName: '办公整机协议', customer: '张倩', goods: 'ThinkCentre M730t', qty: 10, amount: 42000, address: '广州·天河', invoice: '专票/企业', status: '已完成' },
    { purchase: 'B2026081701629', no: '260622105', agreement: 'KO260403250003', agreementName: '外设大宗协议', customer: '马晓燕', goods: '联想无线键鼠套装 KN100', qty: 20, amount: 2580, address: '杭州·余杭未来科技城', invoice: '电子/企业', status: '已发货' },
    { purchase: 'B2026081701630', no: '260621102', agreement: 'KO260403250001', agreementName: '2025采购框架', customer: '黄志远', goods: 'ThinkPad X1 Carbon', qty: 4, amount: 31600, address: '深圳·南山科技园', invoice: '专票/企业', status: '已完成' }
  ];
  ...
  function renderProductOrders() {
    ...
    return '<div class="page-content apo-page"><div class="apo-head"><div><h1>协议产品订单管理</h1>'
      ...
      + '<button class="btn btn-secondary" onclick="agreementProductOrderExport()">导出</button></div>'
      ...
      + '<button class="btn btn-primary" onclick="agreementProductOrderQuery()">查询</button></section>'
  ...
  function renderAgreementProductOrderDetail() {
    ...
    return '<div class="page-content apo-page apo-detail"><button class="btn btn-secondary apo-back" onclick="agreementProductOrderBack()">← 返回协议产品订单管理</button>'
      ...
      + '</span><strong>' + esc(order.address) + '</strong><em>商品数量：' + order.qty + '</em></div>'
      + '<div class="apo-address-item"><b>地址 2</b><span>收货人：' + esc(order.customer) + '</span><span>手机号：139****' + order.purchase.slice(-4)
      + '</span><strong>北京市朝阳区望京街道</strong><em>商品数量：1</em></div></div></section>'
  ...
  function injectStyle() {
    ...
    style.textContent += '.apo-filter{grid-template-columns:1fr 1fr .72fr auto}.apo-section h2:before{display:inline-block;width:4px;height:22px;margin-right:10px;vertical-align:-5px;background:#2f6bff;border-radius:4px;content:""}.apo-section h2 small{margin-left:8px;color:#98a2b3;font-size:13px;font-weight:400}.apo-address-item b{color:#344054}.apo-address-item strong{font-weight:400;color:#1d2939}@media(max-width:900px){.apo-address-item{grid-template-columns:1fr}}';
